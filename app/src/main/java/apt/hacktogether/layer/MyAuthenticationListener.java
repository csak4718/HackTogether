...
public class MyAuthenticationListener implements LayerAuthenticationListener {
    ...
    //Called when the user Deauthenticates (logs out). Execute the callback in the current Activity  De-Wei: in Conversation: LayerImpl.getLayerClient().deauthenticate();
