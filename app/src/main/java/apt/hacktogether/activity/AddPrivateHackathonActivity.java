...
public class AddPrivateHackathonActivity extends BaseActivity {
    private ArrayList<String> mPrivateHackathonIdList;
    private String receiveTag;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_private_hackathon);

        Intent it = getIntent();
        receiveTag = it.getStringExtra(Common.EXTRA_TAG);

        // it.getStringArrayListExtra(Common.EXTRA_PRIVATE_HACKATHON_ID_LIST) might be null
        mPrivateHackathonIdList = it.getStringArrayListExtra(Common.EXTRA_PRIVATE_HACKATHON_ID_LIST);
        ...
        if (mPrivateHackathonIdList == null) mPrivateHackathonIdList = new ArrayList<>();
        ...
        while(itr.hasNext()) {
            ...
            if(mPrivateHackathonIdList.contains(hackathonId)) checkBox.setChecked(true);
            ...
            public void onClick(View v) {
                ...
                while(checkItr.hasNext()){
                    ...
                    if(currCheck != null && currCheck.isChecked()){
                        ...
                        mPrivateHackathonIdList.add(hackathonID);
                    }
                }
                ...
                if(receiveTag.equals(Common.TAG_CREATE_PROFILE_ACTIVITY)){
                    EventBus.getDefault().post(new AddPrivateHackathonToCreateProfileEvent(mPrivateHackathonIdList));
                }
                else if(receiveTag.equals(Common.TAG_EDIT_PROFILE_ACTIVITY)){
                    EventBus.getDefault().post(new AddPrivateHackathonToEditProfileEvent(mPrivateHackathonIdList));
                }

                AddPrivateHackathonActivity.this.finish();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_add_private_hackathon, menu);
        return true;
    }
