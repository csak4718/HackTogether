 ...
 */
public class BaseActivity extends ActionBarActivity implements LayerCallbacks, View.OnClickListener{
    ...
    protected void addViewsToFlowLayout(FlowLayout flowLayout, View[] views, Context context){
